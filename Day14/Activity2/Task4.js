...
class Student extends Person {
    ...
    greet() {
        console.log(`Hello ${this.name}, welcome to the App. Your age is ${this.age} and your Student Id is ${this.sId}.`);
    }
...
s1.greet();  // Output: Hello Yusuf, welcome to the App. Your age is 27 and your Student Id is 101.
